              ...
              <div className="w-full">
                ...
                <div className="relative">
                  <input
                    ...
                    name="extProductId"
                    id="extProductId"
                    placeholder="extProductId"
                    value={variants[selectedVariantIndex]?.extProductId || ''}
                    onChange={(e) =>
                      updateVariants(
                        selectedVariantIndex,
                        'extProductId',
              ...
              <div className="w-full">
                ...
                <div className="relative">
                  <input
                    ...
                    name="variant_qty"
                    id="variant_qty"
                    placeholder="variant_qty"
                    value={variants[selectedVariantIndex]?.variant_qty || ''}
                    onChange={(e) =>
                      updateVariants(
                        selectedVariantIndex,
                        'variant_qty',
              ...
              <div className="w-full">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="variant_sale_price"
                    value={
                      variants[selectedVariantIndex]?.variant_sale_price || ''
                    }
                    onChange={(e) =>
                      updateVariants(
                        selectedVariantIndex,
              ...
              <div className="w-full">
                ...
                <div className="relative">
                  <input
                    ...
                    id="variant_regular_price"
                    placeholder="variant_regular_price"
                    value={
                      variants[selectedVariantIndex]?.variant_regular_price ||
                      ''
                    }
                    onChange={(e) =>
                      updateVariants(
              ...
              <div className="w-full">
                ...
                <div className="relative">
                  <input
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    type="number"
                    name="variant_item_size"
                    id="variant_item_size"
                    placeholder="variant_item_size"
                    value={
                      variants[selectedVariantIndex]?.variant_item_size || ''
                    }
                    onChange={(e) =>
                      updateVariants(
                        selectedVariantIndex,
              ...
              {variants &&
                variants.map((variant, index) => (
                  <tr key={index}>
                    ...
                    <td className="border-b border-[#eee] p-4 dark:border-strokedark">
                      <p className="text-sm">
                        {variant.variant_qty ? variant.variant_qty : '-'}
                      </p>
                    </td>
                    <td className="border-b border-[#eee] p-4 dark:border-strokedark">
