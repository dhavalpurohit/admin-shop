...
const packageData: Package[] = [
  {
    no: 1,
    category: "Mens",
    filename: "topsseller.xls",
    date: "12/31/2023 10:00 AM",
    status: "QC Passed",
    total_products: 10,
  },
  {
    ...
    <div className="">
      ...
      <div className="flex items-center bg-white justify-between p-4 rounded-t-xl mt-2">
        <ul className='flex items-center border rounded-lg'>
          <li className={`flex justify-center py-2 px-6 font-medium cursor-pointer rounded-l-lg ${activeTab === 'bulk' ? 'bg-primary text-gray' : 'bg-white text-black'} border-r`} onClick={() => handleTabClick('bulk')}>Bulk Upload</li>
          <li className={`flex justify-center py-2 px-6 font-medium cursor-pointer rounded-r-lg ${activeTab === 'single' ? 'bg-primary text-gray' : 'bg-white text-black'}`} onClick={() => handleTabClick('single')}>Single Upload</li>
        </ul>
        <div className='flex items-center gap-2.5'>
          <CategoryDropdown />
          <SubCategoryDropdown />
              ...
              {packageData.map((packageItem, key) => (
                <tr key={key}>
                  <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                    <p className="text-sm">{packageItem.no}</p>
                  </td>
