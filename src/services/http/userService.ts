...
export class UserService {
  ...
  static async get(url: string, config?: AxiosRequestConfig) {
    try {
      ...
      const response = await UserService.axios.get(url, updatedConfig);
      if (response) {
        return response.data;
      }
    } catch (e) {
      UserService.handleErrors(e as ErrorResponse);
  ...
  static async post(
    ...
    try {
      ...
      const response = await UserService.axios.post(
        url,
        body,
        updatedConfig,
      );
  ...
  static async postWithoutToken(url: string, config?: AxiosRequestConfig) {
    try {
      ...
      const response = await UserService.axios.post(url, updatedConfig);
      if (response) {
        return response.data;
      }
    } catch (e) {
  ...
  static async put(url: string, body?: object, config?: AxiosRequestConfig) {
    try {
      ...
      const response = await UserService.axios.put(url, body, updatedConfig);
      if (response) {
        return response.data;
      }
    } catch (e) {
  ...
  static async delete(url: string, config?: AxiosRequestConfig) {
    try {
      ...
      const response = await UserService.axios.delete(url, updatedConfig);
      if (response) {
        return response.data;
      }
    } catch (e) {
